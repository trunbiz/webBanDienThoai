...
Route::get('/admin', 'Admin\AuthController@adminHome');
...
Route::get('/abc22', function () {
    dd(22);
    return "Admin Page";
});
Route::group(['middleware' => 'admin'], function () {
    Route::group(['prefix' => 'admin'], function () {
        Route::get('/', 'Admin\AuthController@adminHome');
        Route::get('home', 'Admin\AuthController@adminHome');
        // -------------------- quan ly danh muc----------------------
