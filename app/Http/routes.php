...
//Route::post('login', ['as' => 'postlogin', 'uses' => 'Admin\AuthController@login']);
Route::get('admin/password/reset', ['as' => 'getreser', 'uses' => 'Admin\AuthController@email']);

Route::get('admin/logout', ['as' => 'getlogout', 'uses' => 'Admin\AuthController@logout']);

Route::get('/user', 'HomeController@index');
Route::get('/user/edit', 'HomeController@edit');
Route::post('/user/edit', 'HomeController@editUser');
...
// --------------------------------cac cong viec trong admin (backEnd)---------------------------------------
Route::group(['middleware' => 'admin'], function () {
    Route::group(['prefix' => 'admin'], function () {
        ...
        Route::group(['prefix' => '/nhanvien'], function () {
            ...
            Route::get('/create', ['as' => 'shownv', 'uses' => 'Admin_usersController@create']);
            Route::post('/store', ['as' => 'createnv', 'uses' => 'Admin_usersController@store']);

            Route::get('', ['as' => 'getnv', 'uses' => 'Admin_usersController@getlist']);
            Route::get('/del/{id}', ['as' => 'getdelnv', 'uses' => 'Admin_usersController@getdel']);
